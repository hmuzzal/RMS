...
namespace Softcode.Rms.Web.UI.Controllers
{
    public class ApplicationRolesController : BaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("CompanyId,Id,Name,NormalizedName,ConcurrencyStamp")] ApplicationRole applicationRole)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CompanyId,Id,Name,NormalizedName,ConcurrencyStamp")] ApplicationRole applicationRole)
        {
